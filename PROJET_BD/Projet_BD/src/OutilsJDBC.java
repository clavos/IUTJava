...
public class OutilsJDBC {
	...
	// On importe le nombre d'étudiant avec un stage
	...
	// Calcul le nombre d'étudiant sans stage
	public static void nbNonStage() {
		Interface.stage.nbNonStage = Interface.stage.nbEtudiant - Interface.stage.nbStage;
		
	}

	// Importe le nombre d'étudiant sans stage à une date donnée
	public static int nbNonStageD(String année) {
	...
	// Importe le nombre de stage MOYEN depuis n années
